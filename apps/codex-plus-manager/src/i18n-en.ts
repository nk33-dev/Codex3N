...
export const EN_PLAIN: Record<string, string> = {
  ...
  "保存供应商配置": "Save provider configuration",
  "悬浮球模型": "Floating ball model",
  "设置": "Settings",
  "设置保存": "Settings saved",
  ...
  "导入链接": "Import link",
  "导入文件": "Import file",
  "DreamSkin 社区": "Dream Skin community",
  "导入 DreamSkin 主题包": "Import Dream Skin theme package",
  "导入主题包": "Import theme package",
  "DreamSkin 社区主题": "Dream Skin community themes",
  ...
  "名称排序": "By name",
  "社区主题排序": "Sort community themes",
  "正在加载 DreamSkin 社区…": "Loading the Dream Skin community…",
  "没有匹配的社区主题。": "No matching community themes.",
  "DreamSkin 社区暂时没有可用主题。": "The Dream Skin community has no themes available right now.",
  ...
  "检测到网页一键换肤请求。确认后会从固定社区 API 下载，并在本机重新校验大小、SHA-256、ZIP 清单与 Safe CSS。": "A one-click skin change request from the web was detected. After you confirm, it downloads from the fixed community API and re-verifies the size, SHA-256, ZIP manifest and Safe CSS locally.",
  "主题版本 ID": "Theme version ID",
  "链接不能携带任意下载地址、文件路径或命令；安装后主题会进入“我的主题”，不会自动重启 Codex。": "Links cannot carry arbitrary download URLs, file paths or commands; after install the theme is added to “My themes” and Codex does not restart automatically.",
  "下载并安装": "Download and install",
  "悬浮球": "Floating ball",
  "控制下一步建议与回答大纲。": "Control next-step suggestions and answer outlines.",
  "根据当前回答生成下一步建议。": "Generate next-step suggestions from the current answer.",
  "回答大纲": "Answer outline",
  "整理当前回答的结构。": "Organize the structure of the current answer.",
  "搜索市场脚本": "Search marketplace scripts",
  "搜索名称、作者、描述或标签": "Search by name, author, description, or tag",
  "脚本市场排版": "Script marketplace layout",
  "板块": "Grid",
  "列表": "List",
  "没有匹配的市场脚本。": "No matching marketplace scripts.",
  "有未保存的模型修改，确定放弃吗？": "You have unsaved model changes. Discard them?",
  "配置模型": "Configure model",
  "Codex 目标": "Codex goals",
  "尝试从sub2api获取倍率显示": "Try to fetch and show the multiplier from Sub2API",
  ...
  "非 Sub2API 供应商不会请求或显示倍率。": "Providers that are not Sub2API never request or show a multiplier.",
  "Sub2API 倍率未获取": "Sub2API multiplier not fetched",
  "自动压缩": "Auto-compact",
  "上下文窗口与自动压缩值无效，无法同步模型配置。": "The context window and auto-compact values are invalid, so the model configuration cannot be synced.",
  "查看或重新导入 models.json": "View or re-import models.json",
  "导入 models.json": "Import models.json",
  "需要补充供应商模型信息时填写；不填则使用 Codex++ 默认配置（自动压缩 90%、图片原样发送）。从供应商的 models.json 或 model.json 复制，支持多个模型。": "Fill this in when you need to supply extra provider model info; if omitted, the Codex++ defaults apply (auto-compact 90%, images sent as-is). Copy from the provider's models.json or model.json; multiple models are supported.",
  "清除已导入的模型字段，保留上下文窗口": "Clear the imported model fields but keep the context window",
  "清除导入配置": "Clear imported configuration",
  "自动压缩留空时沿用 Codex 默认行为；填写百分比后会按该模型的上下文窗口重新计算阈值。": "Leave auto-compact empty to keep Codex's default behavior; a percentage recalculates the threshold from that model's context window.",
  "未配置目录": "No directory configured",
  ...
  "当前使用中：保留此供应商的 auth 存档，避免 Codex 登录密钥覆盖供应商密钥": "Currently in use: keeps this provider's auth archive so the Codex login key doesn't overwrite the provider key",
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  // 新增模板条目（模型校验、Dream Skin 社区、Sub2API 倍率、模型导入）
  "模型名称重复：{0}": "Duplicate model name: {0}",
  "模型 {0} 的上下文窗口无效；请输入正整数，或使用 K/M 整数后缀。": "Invalid context window for model {0}; enter a positive integer, or use an integer K/M suffix.",
  "模型 {0} 的自动压缩百分比无效；请输入 0 到 100 之间、最多 6 位小数的十进制数。": "Invalid auto-compact percentage for model {0}; enter a decimal between 0 and 100 with at most 6 decimal places.",
  "{0} 个供应商配置；当前使用已选供应商": "{0} provider configurations; using the selected provider",
  "来自 DreamSkin.cc 的已审核主题，共 {0} 套；安装前仍会在本机再次校验。": "Reviewed themes from DreamSkin.cc: {0} in total; each one is verified again on this machine before install.",
  "作者：{0} · {1} · {2} 次下载": "Author: {0} · {1} · {2} downloads",
  "主题包：{0}": "Theme package: {0}",
  "清单更新时间：{0}，当前显示 {1} / {2}": "Manifest updated {0}; showing {1} of {2}",
  "当前缓存倍率：{0}x": "Cached multiplier: {0}x",
  "以下字段由 Codex++ 计算或维护，导入不会覆盖：{0}": "These fields are computed or maintained by Codex++ and are not overwritten by the import: {0}",
